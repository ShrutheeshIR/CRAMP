...
Ported verbatim from the sibling repos' `scripts/figures/blender_paths.py`
(iiwa-bimanual-augmented-jacobian-test, rby1-constrained-planning) so the three
projects resolve Blender the same way.
"""
...
# Blender gives to locally installed (non-remote) extensions. Unlike the sibling
# repos, this project does not vendor or install the add-on -- it verifies the
# one already installed here; see check_meshcat_importer.py.
